...
# Secret key for production (move to environment variables in production)
...
ROOT_URLCONF = 'dental_management_platform.urls'
...
WSGI_APPLICATION = 'dental_management_platform.wsgi.application'
